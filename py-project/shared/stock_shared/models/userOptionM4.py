"""
user_option_m4 — M4(지정가 감시) 개인화 옵션.

  · 모든 값 NULL 허용. NULL = KospiStrategy4 클래스 기본값 사용
...
→ 설계문서(auto-trade-design.md §5-3)의 user_option_m4 를 대체한다.
...
class UserOptionM4(Base):
    __tablename__ = "user_option_m4"
